...
from model.adapt_moldule import AdaptModule
...
class my_DeformConv2d(nn.Module):
    def __init__(self, inc, outc, kernel_size=3, padding=1, stride=1, bias=None, modulation=False):
        """
        Args:
            modulation (bool, optional): If True, Modulated Defomable Convolution (Deformable ConvNets v2).
        """
        super(my_DeformConv2d, self).__init__()
        ...
        self.p_conv = AdaptModule(in_channels=1, out_channels=1, kernel_size=3, padding=1)
